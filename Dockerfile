...
CMD ["sh", "-c", "go vet ./... && go test -v -count=1 ./... && CGO_ENABLED=1 go test -race -count=1 ./internal/cmdexec/... ./internal/fileupload/... ./internal/keystore/... ./internal/server/... ./internal/mcp/..."]
